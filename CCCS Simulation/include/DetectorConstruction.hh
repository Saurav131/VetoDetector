...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    // get methods
    //
    const G4VPhysicalVolume* GetIcPV() const;
  ...
  // we add logical volume of our detector here so that sensitive volume can refer to this logical volume outside of construct function
    ...
    G4VPhysicalVolume* fIcPV = nullptr; // the absorber physical volume
    G4VPhysicalVolume* fVetoPV = nullptr;      // the gap physical volume
    G4VPhysicalVolume* fDetectorPV = nullptr;      // the gap physical volume
...
inline const G4VPhysicalVolume* DetectorConstruction::GetIcPV() const {
  return fIcPV;
}
